...
def load_file(filename):
    ...
    print(f"{Color.YELLOW}Tree succesfully loaded from{Color.OFF} '{filename}'")
...
reserved_words = pp.oneOf('true false full all_pos all_neg LEL RFS node SR cons load show relevant')
...
action = show_classes | show_features | load
...
# Classification
classification = pp.Word(pp.alphanums) + pp.Suppress('(') + var_or_const + pp.Suppress(')')
...
# REPL loop
print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
print(f"{Color.CYAN} ExplainDT {Color.OFF} v1.0")
print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
while True:
